...
public class AuthController : BaseController
{
    ...
    /// </summary>
    /// <param name="registerUserDto">User credentials and info</param>
    ...
    public async Task<IActionResult> Register(
        [FromForm] RegisterUserDto registerUserDto, CancellationToken cancellationToken)
    {
        var command = new CreateUserCommand(
            Email: registerUserDto.Email, Password: registerUserDto.Password,
            FirstName: registerUserDto.FirstName, LastName: registerUserDto.LastName);
